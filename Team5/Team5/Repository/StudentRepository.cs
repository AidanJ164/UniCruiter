...
namespace UniCruiter.Repository
{
    public class StudentRepository : IStudentRepository, IDisposable
    {
        ...
        public async Task<IList<Student>> GetStudents(StudentViewModel studentViewModel)
        {
            ...
            //Filter by Name
            if (!string.IsNullOrEmpty(studentViewModel.FirstName) && !string.IsNullOrEmpty(studentViewModel.LastName))
            {
            ...
            else if (!string.IsNullOrEmpty(studentViewModel.FirstName) && string.IsNullOrEmpty(studentViewModel.LastName))
            {
                students = students.Where(s =>
                    s.FirstName.StartsWith(studentViewModel.FirstName)
                );
